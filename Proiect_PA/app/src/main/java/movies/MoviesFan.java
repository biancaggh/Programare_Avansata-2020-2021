...
//        action.put("title","The Addams Family");
//        action.put("director","Barry Sonnenfeld");
//        action.put("genre0","Fantasy");
//        action.put("genre1","Comedy");
//        action.put("actor0","Anjelica Huston");
//        action.put("actor1","Raul Julia");
//        action.put("actor2","Christopher Lloyd");
//        action.put("gsize","2");
//        action.put("asize","3");
//        action.put("image","https://www.imdb.com/title/tt0101272/mediaviewer/rm735038464/");
//        action.put("runtime","99 min");
//        action.put("rating","6.9");
//        action.put("release_date","22.11.1991");
//        action.put("synopsys","Con artists plan to fleece an eccentric family using an accomplice who claims to be their long-lost uncle.");
//
//        db.collection("/MOVIES/movies/fantastic").document("2").set(action).
//                addOnSuccessListener(new OnSuccessListener<Void>() {
//                    @Override
//                    public void onSuccess(Void aVoid) {
//                        Toast.makeText(MoviesFan.this,"Add new Fantasy Movie", Toast.LENGTH_LONG).show();
//                    }
...
//        });
    ...
    private void showData() {
        db.collection("/MOVIES/movies/fantastic").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
    ...
    private void readMovie() {
        ...
        DocumentReference documentReference = db.collection("/MOVIES/movies/fantastic").document("1");
