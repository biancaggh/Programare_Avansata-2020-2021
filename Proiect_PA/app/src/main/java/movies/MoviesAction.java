...
//        action.put("title","The Dark Knight");
        //action.put("director","Christopher Nolan");
//        action.put("genre0","Action");
//        action.put("genre1","Drama");
//        action.put("genre2","Crime");
//        action.put("actor0","Heath Ledger");
//        action.put("actor1","Christian Bale");
//        action.put("actor2","Aaron Eckhart");
//        action.put("gsize","3");
//        action.put("asize","3");
//        action.put("image","https://uproxx.com/wp-content/uploads/2018/05/patton_joker.jpg");
//        action.put("runtime","152 min");
//        action.put("rating","9");
//        action.put("release_date","25.07.2008");
//        action.put("synopsys","When the menace known as the Joker wreaks havoc and chaos on the people of Gotham, Batman must accept one of the greatest psychological and physical tests of his ability to fight injustice.");
//
//        db.collection("/MOVIES/movies/action").document("2").set(action).
//                addOnSuccessListener(new OnSuccessListener<Void>() {
//                    @Override
//                    public void onSuccess(Void aVoid) {
//                        Toast.makeText(MoviesAction.this,"Add new Action Movie",Toast.LENGTH_LONG).show();
//                    }
...
//        });
    ...
    private void showData() {
        db.collection("/MOVIES/movies/action").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
    ...
    private void readMovie() {
        ...
        DocumentReference documentReference = db.collection("/MOVIES/movies/action").document("1");
